 ...
 * @author Usuario
 */
public class ConsultarUsuarioPorID extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ConsultarUsuarioPorID.class.getName());

    /**
     * Creates new form ConsultarUsuarioPorID
     */
...
private void limparCampos() {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Consultar Usuário por ID:");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ConsultarUsuarioPorID().setVisible(true));
    }
