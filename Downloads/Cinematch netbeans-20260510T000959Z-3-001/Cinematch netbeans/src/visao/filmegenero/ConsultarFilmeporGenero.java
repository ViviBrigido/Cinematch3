 ...
 * @author Vitoria
 */
public class ConsultarFilmeporGenero extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ConsultarFilmeporGenero.class.getName());

    /**
     * Creates new form ConsultarFilmeporGenero
     */
    public ConsultarFilmeporGenero() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Consultar Genero por Filme");

        jLabel1.setText("ID_Filme:");
    ...
    java.util.ArrayList<modelo.Filme_genero> lista = fgc.consultarGeneroPorFilme(id);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ConsultarFilmeporGenero().setVisible(true));
    }
